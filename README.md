...
```sh
  cd my-folder
  git clone https://github.com/mhnazary/Leaderboard.git
```
--->
...
I would like to thank to my family and God for the opportunities to always improve despite adversity, friends for being there for me, and Microverse for providing a platform to achieve this goal. 
